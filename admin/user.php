     ...
     <!--Menu de coté-->
      <div class="sidebar-menu">
          ...
          <ul>
              ...
              <li><a href="#"><span class="vid"><i class="icon fas fa-video"></i></span><span>&nbsp; Programmes</span></a></li>
          </ul>
      </div>
     <!--!Menu de coté-->
 </div>
                 ...
                 <table>
                    ...
                    <tbody>
                       <?php 
                        ...
                        $membres = "SELECT * FROM inscription";
                        $result = mysqli_query($con,$membres);
                        ...
                        <td>",$row['email'],"</td>
                        <td>",$row['password'],"</td>
                        <td><button id='btns'><a style='color:#fff' href=suppUser.php?id=".$row['id']." id='supp'>Supprimer</a></button></td>
