 ...
 <div class="sidebar">
     ...
     <!--Menu de coté-->
      <div class="sidebar-menu">
          ...
          <ul>
              <li><a href="admin.php"><span class="add"></span><i class="icon fas fa-user"></i><span>&nbsp; Admin</span></a></li>
 ...
 <div class="main-content">
   ...
   <!--midle-->
    <main>
       ...
       <div class="article">
       <center>
         <h2>Edition des articles</h2><br/><br/>
         <form method="POST" action="" enctype="multipart/form-data">
         <input type="text" name="pseudo" placeholder="Admin pseudo" required><br/><br/>  
         <input type="text" name="titre" placeholder="Entrer le titre de l'article" required><br/><br/>
         <textarea name="contenu" style="width: 350px; height:100px;" placeholder="Contenu de l'article"></textarea></br><br/>
         <input type="file" name="fichier"><br/><br/>     
         <input type="submit" name="content" value="Envoyer">       
         </form>
       </div>
       </center>
    </main>
